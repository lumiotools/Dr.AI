...
export const AuthPage: React.FC<AuthProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 sm:p-6 bg-emerald-950">
      <div className="w-full max-w-md">
        <h1 className="text-3xl sm:text-4xl font-bold text-amber-500 mb-8 text-center">
          Welcome to Dr. AI
        </h1>
        ...
        <div className="space-y-4">
          <Input
            ...
            className="bg-emerald-900/50 border-emerald-700 w-full"
          />
